...
VALUES ('Queretaro', 'Casa de 200 metros cuadrados, 5 recamaras y 3 baños', '1,000,000', 'casa1.jpg', 'Casa', 
...
VALUES ('Queretaro', 'Casa de 300 metros cuadrados, dentro del fraccionamiento la vista, 5 recamaras, 3 baños, cocina equipada',
 '3,100,000', 'casa2.jpg', 'Casa', 
  'Fraccionamiento la vista, #123, interior la luna', 'Venta','1');

INSERT INTO products(city, description, price, image, category, address, tipo, disponible)
VALUES ('Queretaro', 'Casa de 250 metros cuadrados, 3 recamaras, 3 baños patio de recreación, con cocina semi equipada', '3,500', 'casa3.jpeg', 'Casa', 
  'Fracionamiento el refugio, #13', 'Renta','1');

INSERT INTO products(city, description, price, image, category, address, tipo, disponible)
VALUES ('Morelia', 'Casa de 100 metros cuadrados, 2 recamaras y 3 baños', '1,000,000', 'casa4.jpg', 'Casa', 
  'Lomas villas, #1212', 'Venta','1');

INSERT INTO products(city, description, price, image, category, address, tipo, disponible)
VALUES ('Monterrey', 'Casa de 400 metros cuadrados, 3 recamaras y 1 baño', '3,500,000', 'casa6.jpg', 'Casa', 
  'Lomas del campestre, #121', 'Venta','1');


INSERT INTO products(city, description, price, image, category, address, tipo, disponible)
VALUES ('Morelia', 'Departamento de 250 metros cuadrados, 2 recamaras y 3 baños', '4,600', 'departamento1.jpeg', 'Departamento', 
  'El campestre, #23 ', 'Renta','1');

INSERT INTO products(city, description, price, image, category, address, tipo, disponible)
VALUES ('Leon', 'Departamento de 110 metros cuadrados, 2 recamaras y 1 baño, cocina y muebles incluidos', '2,000', 'departamento2.jpg', 'Departamento', 
  'El campestre, #23 ', 'Renta','1');

INSERT INTO products(city, description, price, image, category, address, tipo, disponible)
VALUES ('CDMX', 'Departamento en Santa fe, 3 recamaras, 2 baños, alberca, cocina equipada, sala equipada', '15,000', 'departamento3.jpg', 'Departamento', 
  'Santa fe, #1223 ', 'Renta','1');

INSERT INTO products(city, description, price, image, category, address, tipo, disponible)
VALUES ('Queretaro', 'Departamento de 250 metros cuadrados, 4 recamaras y 3 baños', '2,250,000', 'departamento5.jpg', 'Departamento', 
  'Juriquilla, #23, altos de nuevo toledo', 'Venta','1');

INSERT INTO products(city, description, price, image, category, address, tipo, disponible)
VALUES ('Guadalajara', 'Departamento de 150 metros cuadrados, 2 recamaras y 2 baños', '1,150,000', 'departamento6.jpg', 'Departamento', 
  'Periferico, #23, altos de nuevo azul', 'Venta','1');



INSERT INTO products(city, description, price, image, category, address, tipo, disponible)
VALUES ('Guadalajara', 'Terreno en venta 20 metros cubicos', '150,000', 'terreno1.jpeg', 'Terreno', 
  'Fraccionamiento la cienega, altos de nuevo azul', 'Venta','1');

INSERT INTO products(city, description, price, image, category, address, tipo, disponible)
VALUES ('Morelia', 'Terreno en venta 20 metros cubicos', '150,000', 'terreno2.jpg', 'Terreno', 
  'Avenida del estudiante, 9 de junio', 'Venta','1');

INSERT INTO products(city, description, price, image, category, address, tipo, disponible)
VALUES ('Leon', 'Terreno en venta 20 metros cubicos', '50,000', 'terreno3.jpg', 'Terreno', 
...
INSERT INTO products(city, description, price, image, category, address, tipo, disponible)
VALUES ('Morelia', 'Local en venta 20 metros cubicos', '150,000', 'local1.jpg', 'Local', 
  'plaza de torreon nuevo', 'Venta','1');

INSERT INTO products(city, description, price, image, category, address, tipo, disponible)
VALUES ('Leon', 'Local en renta 20 metros cubicos', '2,000', 'local2.jpeg', 'Local', 
  'hacienda de correalejo, #432', 'Renta','1');

INSERT INTO products(city, description, price, image, category, address, tipo, disponible)
VALUES ('Morelia', 'Local en renta 20 metros cubicos', '1,550', 'local3.jpg', 'Local', 
